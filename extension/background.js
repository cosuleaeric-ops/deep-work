const BLOCK_RULE_IDS = [1, 2, 3, 4, 5, 6, 7, 8, 9];
const BLOCK_RULES = [
  ...
  { id: 9, priority: 2, action: { type: "block" }, condition: { regexFilter: "^https?://([a-zA-Z0-9.-]+\\.)*(twitter\\.com|x\\.com)(/|$)", resourceTypes: ["main_frame"] } },
];
